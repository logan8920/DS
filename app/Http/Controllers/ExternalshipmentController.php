    ...
    public function index()
    {
        ...
        $tabs = [
            "COD" => [
                ...
                "url" => route('externalshipment.type', 'COD')
            ],
            "Prepaid" => [
                "colDefs" => [
                    [
                ...
                "url" => route('externalshipment.type', 'Prepaid')
            ],
            "Confirmed" => [
                "colDefs" => [
                    [
                ...
                "url" => route('externalshipment.type', 'Confirmed')
            ],
            "Cancelled" => [
                "colDefs" => [
                    [
                ...
                "url" => route('externalshipment.type', 'Cancelled')
            ],
            "Unprocessable Order" => [
                "colDefs" => [
                    [
                ...
                "url" => route('externalshipment.type', 'Unprocessable Order')
            ],
            "All" => [
                "colDefs" => [
                    [
                ...
                "url" => route('externalshipment.type', 'All')
            ],
            "Sync Error" => [
                "colDefs" => [
                    [
                ...
                "url" => route('externalshipment.type', 'Sync Error')
            ]
        ];

        $defaultTabs = "COD";

        $firstRoute = route('externalshipment.type', 'COD');
        return view('pages.comman-table', compact('tabs', 'firstRoute', 'defaultTabs', 'pageHeading'));
    }

    public function externalshipmentType(Request $request)
    {
