...
class BillingController extends Controller
{
    ...
    public function marginremittance()
    {
        $pageHeading = "Billing Marginremittance";
        $tabs = [
            "Marginremittance" => [
                "colDefs" => [
                    [
                ...
                "url" => route('billing.marginremittance.ajax')
            ]
        ];

        $cards = [
            "Total Margin Amount" => "00.00",
            "Remitted Till Date" => "00.00",
            "Total Remittance Due" => "00.00",
            "Last Remittance" => "00.00",
            "Next Remittance Due" => "00.00",
            "Advance Adjusted Amount" => "00.00"
        ];

        $defaultTabs = "Marginremittance";

        $firstRoute = route('billing.marginremittance.ajax');
        return view('pages.billing.marginremittance', compact('tabs', 'firstRoute', 'defaultTabs', 'pageHeading','cards'));
    }

    public function marginremittanceAjax(Request $request)
    {
        $data = [
            [
    ...
    {
        $pageHeading = "Billing Prepaid Payment";
        $tabs = [
            "Prepaid Payment" => [
                "colDefs" => [
                    [
                ...
                "url" => route('billing.prepaidpayment.ajax')
            ]
        ];

        $defaultTabs = "Prepaid Payment";

        $firstRoute = route('billing.prepaidpayment.ajax');
        return view('pages.billing.marginremittance', compact('tabs', 'firstRoute', 'defaultTabs', 'pageHeading'));
    }

    public function prepaidpaymentAjax(Request $request)
    {
        $data = [
            [
                'order_date' => '2025-08-16',
