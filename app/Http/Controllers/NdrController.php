    ...
    public function index()
    {
        ...
        $tabs = [
            ...
            "Unprocessable Order" => [
                ...
                "url" => route('ndr.type', 'Unprocessable Order')
            ],
            "All" => [
                "colDefs" => [
                    [
            ...
            "Sync Error" => [
                ...
                "url" => route('ndr.type', 'Sync Error')
            ]
        ];

        $defaultTabs = "COD";

        $firstRoute = route('ndr.type', 'COD');
        return view('pages.comman-table', compact('tabs', 'firstRoute', 'defaultTabs','pageHeading'));
    }

    public function ndrType(Request $request)
    {
