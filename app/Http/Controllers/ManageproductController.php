    ...
    public function index()
    {
        ...
        $tabs = [
            "COD" => [
                ...
                "filter" => [
                    ...
                    "Status" => [
                        ...
                        "option" => [
                            ...
                            "18" => "manageproduct Lost",
                            "19" => "manageproduct Damaged",
                            "20" => "Order Confirmation In Process",
                            "21" => "manageproduct Cancelled",
                            "22" => "Out for Pickup",
                ...
                "url" => route('manageproduct.type', 'COD')
            ],
            "Prepaid" => [
                "colDefs" => [
                    [
                ...
                "url" => route('manageproduct.type', 'Prepaid')
            ],
            "Confirmed" => [
                "colDefs" => [
                    [
                ...
                "url" => route('manageproduct.type', 'Confirmed')
            ],
            "Cancelled" => [
                "colDefs" => [
                    [
                ...
                "url" => route('manageproduct.type', 'Cancelled')
            ],
            "Unprocessable Order" => [
                "colDefs" => [
                    [
                ...
                "url" => route('manageproduct.type', 'Unprocessable Order')
            ],
            "All" => [
                "colDefs" => [
                    [
                ...
                "url" => route('manageproduct.type', 'All')
            ],
            "Sync Error" => [
                "colDefs" => [
                    [
                ...
                "url" => route('manageproduct.type', 'Sync Error')
            ]
        ];

        $defaultTabs = "COD";

        $firstRoute = route('manageproduct.type', 'COD');
        return view('pages.comman-table', compact('tabs', 'firstRoute', 'defaultTabs','pageHeading'));
    }

    public function manageproductType(Request $request)
    {
