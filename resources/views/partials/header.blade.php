            ...
            <div class="header-right ml-4">
                ...
                <div class="dropdown cart-dropdown cart-offcanvas d-flex mr-0 mr-lg-2">
                    ...
                    <a href="#" class="cart-toggle label-down link">
                        <span
                            class="cart-label d-flex flex-column justify-content-center text-right d-lg-show">Shopping
                            Cart
            ...
            <div class="inner-wrap">
                <div class="header-left">
                    {{-- <div class="dropdown category-dropdown">
                        <a href="#" class="category-toggle text-capitalize pl-0 bg-white" role="button"
                                            ...
                                            <div class="menu-banner banner-fixed menu-banner3">
                                                ...
                                                <div class="banner-content">
                                                    ...
                                                    <div class="banner-price-info text-white font-weight-normal ls-25">
                                                        Up to <span
                                                            class="text-primary text-uppercase font-weight-bold">25%
                                                            Off</span></div>
                                                    <a href="demo15-shop.html"
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner4">
                                                ...
                                                <div class="banner-content">
                                                    ...
                                                    <div
                                                        class="banner-price-info text-primary font-weight-bolder text-uppercase text-primary">
                                                        20% Off</div>
                                                    <a href="demo15-shop.html"
