        ...
        <div class="tab-content">
            <div class="tab-pane active" id="main-menu">
                <ul class="mobile-menu">
                    <li><a href="demo15.html">Home</a></li>
                    <li>
                        <a href="demo15-shop.html">Shop</a>
                        <ul>
                            <li>
                                <a href="#">Shop Pages</a>
                                <ul>
                    ...
                    <li><a href="https://d-themes.com/buynow/wolmartwp">Buy Wolmart!</a></li>
                </ul>
            </div>
            <div class="tab-pane" id="categories">
                <ul class="mobile-menu">
                    ...
                    <li>
                        <a href="demo15-shop.html" class="font-weight-bold text-primary text-uppercase ls-25">
