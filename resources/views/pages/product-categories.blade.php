        ...
        <div class="page-content mb-10">
            <div class="container-fluid">
                ...
                <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6 br-xs"
                    style="background-image: url(assets/images/demos/demo15/banner/shop-banner.jpg); background-color: #FFC001;">
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-uppercase font-weight-bold">
                            Check New Remote
                        </h4>
                        <h3 class="banner-title text-white text-uppercase mb-5">Smart Joy Sticks</h3>
                        <a href="demo15-shop.html" class="btn btn-dark btn-rounded btn-icon-right">Discover Now<i
                ...
                <div class="shop-content row gutter-lg">
                    ...
                    <div class="main-content">
                        ...
                        <div class="product-wrapper row cols-xl-6 cols-lg-4 cols-md-3 cols-2">
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="product-default.html">White School Bag</a>
                                        </h4>
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="assets/images/demos/demo15/products/4-1-1.jpg" alt="Product"
                                                width="300" height="338">
                                            <img src="assets/images/demos/demo15/products/4-1-2.jpg" alt="Product"
                                                width="300" height="338">
                                        </a>
                                        <div class="product-action-horizontal">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="assets/images/demos/demo15/products/4-2-1.jpg" alt="Product"
                                                width="300" height="338">
                                            <img src="assets/images/demos/demo15/products/4-2-2.jpg" alt="Product"
                                                width="300" height="338">
                                        </a>
                                        <div class="product-label-group">
                                            <label class="product-label label-hot">Hot</label>
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="assets/images/demos/demo15/products/3-4-1.jpg" alt="Product"
                                                width="300" height="338">
                                            <img src="assets/images/demos/demo15/products/3-4-2.jpg" alt="Product"
                                                width="300" height="338">
                                        </a>
                                        <div class="product-label-group">
                                            <label class="product-label label-sale">19% off</label>
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="assets/images/demos/demo15/products/3-1-1.jpg" alt="Product"
                                                width="300" height="338">
                                            <img src="assets/images/demos/demo15/products/3-1-2.jpg" alt="Product"
                                                width="300" height="338">
                                        </a>
                                        <div class="product-action-horizontal">
                                            <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="product-default.html">
                                            <img src="assets/images/demos/demo15/products/3-2-1.jpg" alt="Product"
                                                width="300" height="338">
                                            <img src="assets/images/demos/demo15/products/3-2-2.jpg" alt="Product"
                                                width="300" height="338">
                                        </a>
                                        <div class="product-label-group">
                                            <label class="product-label label-sale">19% off</label>
