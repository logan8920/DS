                        ...
                        <div class="product product-single row">
                                                ...
                                                <div class="swiper-slide" data-srr="{{ $image->image_path }}">
                                                    <figure data-srr="{{ $image->image_path }}" class="product-image">
                                                        <img src="{{ $image->image_path ? (str_contains_any($image->image_path,['http','https']) ? $image->image_path : asset(Storage::url($image->image_path))):  asset('assets/brand_icon.png') }}"
                                                            data-zoom-image="{{ $image->image_path ? (str_contains_any($image->image_path,['http','https']) ? $image->image_path : asset(Storage::url($image->image_path))) :  asset('assets/brand_icon.png') }}"
                                                ...
                                                <div class="product-thumb swiper-slide">
                                                    ...
                                                    @elseif(in_array($ext, $videoExt))
                                                        <video 
                                                            ...
                                                            controls
                                                        >
                                                            <source src="{{ str_contains_any($image['image_path'],['http','https']) ? $image['image_path'] : asset(Storage::url($image['image_path'])) }}" type="video/{{ $ext }}">
                            ...
                            <div class="col-md-6 mb-4 mb-md-6">
                                <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                    ...
                                    @if ($product->category)
                                        <div data-srr="{{ str_contains_any($product?->category?->icon, ['http', 'https']) ? $product?->category?->icon : asset("images/categories/".$product?->category?->icon) }}" class="product-bm-wrapper">
                                            <figure class="brand">
